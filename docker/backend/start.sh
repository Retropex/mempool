...
__MEMPOOL_INDEXING_START_HEIGHT__=${MEMPOOL_INDEXING_START_HEIGHT:=0}
...
sed -i "s!__MEMPOOL_INDEXING_START_HEIGHT__!${__MEMPOOL_INDEXING_START_HEIGHT__}!g" mempool-config.json
